## 1. Write a Java program to find the Least Common Set of 2 integers. For example, the least common multiple of 4 and 5 is 20
...
| :---: | :---: | :---: |
| 1 | `    bbbbbb    ` | `bbbbbb` |
| 2 | ` hello   xin chao  moi    nguoi` | `hello xin chao moi nguoi` |
